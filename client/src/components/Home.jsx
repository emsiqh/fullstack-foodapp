...
import { randomData } from '../utils/fakeData';
        ...
        <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col items-start justify-start gap-6">
                <div className="px-4 py-1 flex items-center justify-center gap-2 bg-orange-100 rounded-full">
                    <p className="text-lg font-semibold text-orange-500">Free
                        Delivery</p>
                    ...
                    {randomData &&
                        randomData.map((data, i) => (
                            ...
                            >
                                <img
                                    src={data.imageURL}
                                    className="w-12 h-12 md:w-32 md:h-32 md:-mt-4 object-contain "
                                    alt=""
                                />
                                <p className="text-sm_lg:text-xl font-semibold text-textColor">
